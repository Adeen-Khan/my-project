...
#define L_DIR1_Pin GPIO_PIN_8
#define L_DIR1_GPIO_Port GPIOC
#define L_DIR2_Pin GPIO_PIN_9
#define L_DIR2_GPIO_Port GPIOC
...
#define R_DIR1_Pin GPIO_PIN_10
#define R_DIR1_GPIO_Port GPIOC
#define R_DIR2_Pin GPIO_PIN_11
#define R_DIR2_GPIO_Port GPIOC
#define L_ENC_A_Pin GPIO_PIN_0
#define L_ENC_A_GPIO_Port GPIOD
#define L_ENC_A_EXTI_IRQn EXTI0_IRQn
#define L_ENC_B_Pin GPIO_PIN_1
#define L_ENC_B_GPIO_Port GPIOD
#define R_ENC_A_Pin GPIO_PIN_2
#define R_ENC_A_GPIO_Port GPIOD
#define R_ENC_A_EXTI_IRQn EXTI2_TSC_IRQn
#define R_ENC_B_Pin GPIO_PIN_3
#define R_ENC_B_GPIO_Port GPIOD
